...
//
//  override lazy val wireMockServicePort = 8015
//
...
//        )
//      )))
//      connector.validPaperlessUserWith(utr).futureValue shouldBe PaperlessUser(utr)
//    }
//
...
//
//      intercept[UnknownTaxId] { await(connector.validPaperlessUserWith(utr)) }
//    }
//
...
//
//  trait TestCase {
//    def entityResolverBaseUrl = s"http://localhost:$wireMockServicePort"
