...
case class SecureMessageV2(recipient: RecipientV2, externalRef: ExternalReferenceV2, messageType: String, subject: String, content: String, validFrom: LocalDate, details: Details)
